...
# # Function for SIR model with vital dynamics
# simulate_SIR <- function(S0, I0, R0, beta, gamma, mu, n_steps) {
...
# # Run the simulations
# all_runs <- lapply(1:n_runs, function(x) simulate_SIR(S0, I0, R0, beta, gamma, mu, n_steps))
...
#   labs(title = "Stochastic SIR Model with Vital Dynamics",
#        x = "Time",
#        y = "Population",
#        color = "Compartment") +
