...
# Plot subplots for SEIRD model compartments
plotSubPlotsSEIRD <- function(model) {
  data_long <- tidyr::pivot_longer(model, cols = c(S, E, I, R, D), names_to = "Compartment", values_to = "Value")
  ...
  compartmentLabels <- c(S = "Susceptible", E = "Exposed", I = "Infected", R = "Recovered", D = "Dead")
