...
# Plot phase plane for SIRD model
...
# Plot subplots for SIRD model compartments
plotSubPlotsSIRD <- function(model) {
  data_long <- tidyr::pivot_longer(model, cols = c(S, I, R, D), names_to = "Compartment", values_to = "Value")
