...
episimModelAuthorshipTab <- function() {
  tabPanel(
    ...
    ## FIXME: we can't really /all/ be the lead developers when there's just
    ## three of us. Who are we leading? We're either just the development team,
    ## or there's one lead developer leading a team of senior and junior
    ## developers. The writing here could use improvement, regardless of this
    ## nitpick.
    p(span("Tobias Wondwossen, Khanh Le, Bryce Carson",
    ...
    p("Email:",
      a("akrishnamurthy@mtroyal.ca",
        href = "mailto:akrishnamurthy@mtroyal.ca")),
    p("Website:",
      a(href = "https://bit.ly/2YKrXjX",
    ...
    p(gsub(
      "\n", "",
      "This tool uses a mathematical model to simulate epidemic model \
